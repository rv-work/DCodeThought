  ...
  return (
    <div className="min-h-screen w-full flex bg-background">
      ...
      <div className="hidden lg:flex relative w-1/2 bg-background-secondary/30 border-r border-border-subtle overflow-hidden flex-col justify-between p-12">
        ...
        <div className="absolute top-[-10%] left-[-10%] w-125 h-125 bg-blue-600/20 rounded-full blur-[120px] animate-float"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-125 h-125 bg-purple-600/20 rounded-full blur-[120px] animate-float" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="relative z-10 max-w-lg animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-sm font-bold tracking-wide uppercase mb-6">
          ...
          <p className="text-lg text-muted mb-8 leading-relaxed">
            Pick up right where you left off. Continue building your problem-solving intuition with our thought-first explanations and multi-language solutions.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden">
        ...
        {/* Mobile-only background glow (since left panel is hidden on mobile) */}
        <div className="lg:hidden absolute top-[-10%] right-[-10%] w-75 h-75 bg-blue-600/10 rounded-full blur-[100px]"></div>

        <div className="w-full max-w-md animate-scale-in z-10">

          {/* Mobile-only Header */}
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-linear-to-br from-blue-500/20 to-purple-500/20 border border-blue-500/30 backdrop-blur-md mb-4">
          ...
          <div className="relative group">
            {/* Form Card Glow */}
            <div className="absolute -inset-1 bg-linear-to-r from-blue-500 to-purple-500 rounded-3xl blur-xl opacity-10 group-hover:opacity-20 transition-opacity duration-500"></div>
            ...
            <div className="relative rounded-3xl bg-background-secondary/60 backdrop-blur-xl border border-border-subtle p-6 md:p-10 shadow-2xl animate-fade-in-up opacity-0" style={{ animationDelay: '0.2s' }}>
              ...
              <Link
                href="/signup"
                className="group flex items-center justify-center gap-2 w-full px-6 py-4 rounded-xl border border-border-subtle bg-background/50 hover:bg-blue-500/5 hover:border-blue-500/30 text-foreground font-bold transition-all duration-300 hover:shadow-[0_0_20px_rgba(59,130,246,0.1)]"
              >
                Create an account
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 text-blue-500 transition-transform" />
              </Link>
            </div>
          </div>
